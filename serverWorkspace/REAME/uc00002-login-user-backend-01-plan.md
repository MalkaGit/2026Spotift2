...
V1 = simple login with ONE access token only
❌ No refresh tokens
❌ No sessions
❌ No rotation
❌ No cookies
...
Here is the Login User operation, regenerated exactly in the same template and quality as your Register User one.



You can drop this directly into your design doc.
...
Allow a registered user to authenticate and receive an access token
