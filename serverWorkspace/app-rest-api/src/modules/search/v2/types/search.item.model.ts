 ...
 * - GET /search/v2/artists   - Returns array of SearchItem objects in response body: { items: SearchItem[] }
 * - GET /search/v2/albums    - Returns array of SearchItem objects (future)
 * - GET /search/v2/tracks    - Returns array of SearchItem objects (future)
 * - GET /search/v2/playlists - Returns array of SearchItem objects (future)
 * 
