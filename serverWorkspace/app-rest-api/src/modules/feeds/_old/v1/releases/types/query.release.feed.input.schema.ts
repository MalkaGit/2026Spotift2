import { z } from "zod";
import { RELEASE_FEED_EVENT_TYPES, type ReleaseFeedEventType } from "./query.release.feed.input.model";

export const QueryReleaseFeedInputSchema = z.object({
  event_type: z
    .string()
    .optional()
    .refine(
      (s) => {
        ...
        return parts.every((p) => RELEASE_FEED_EVENT_TYPES.includes(p as ReleaseFeedEventType));
      },
